          ...
          <div className="space-y-6">
            ...
            <div>
              <button
                ...
                className="flex w-full h-10 focus:outline-none focus:bg-[#2a7067] items-center justify-center rounded-md bg-[#449388] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm "
              >
